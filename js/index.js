...
function ejercicio5(){
    ...
    //Hacemos un Set con el array para eliminar duplicados
    emails = new Set(emails);
    console.log(emails);
}

//Añadimos los eventos a cada boton
document.getElementById("ejercicio1").onclick = ejercicio1;
document.getElementById("ejercicio2").onclick = ejercicio2;
document.getElementById("ejercicio3").onclick = ejercicio3;
document.getElementById("ejercicio4").onclick = ejercicio4;
document.getElementById("ejercicio5").onclick = ejercicio5;